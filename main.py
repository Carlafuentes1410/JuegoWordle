...
class Wordle(Frame):
    ...
    def create_widgets(self):
        ...
        self.limpiar = Button (self.frame_control, text = 'Limpiar', bg='gray50',activebackground='green2',
    ...
    def verificar_palabra(self):
        ...
        x = list(filter(lambda x:palabra in x , self.lista))
        if len (x)==1:
            self.signal['text'] = ''
...
if __name__ == "__main__":
    ...
    ventana.call('wm', 'iconphoto', ventana._w, PhotoImage(file='C:/Users/Gonzalez/Documents/Phyton/JuegoWordle/Wordle_logo.png'))
